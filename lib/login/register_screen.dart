...
class _MyRegisterState extends State<MyRegister> {
  ...
  TextEditingController _emailaddController = TextEditingController();
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
            image: AssetImage('assets/images/registerimage.png'), fit: BoxFit.cover),
      ),
      child: Scaffold(
                                ...
                                CircleAvatar(
                                  ...
                                  child: IconButton(
                                      ...
                                      onPressed: () async{
                                        ...
                                        await loginPageData.saveJsonData(rawData);
                                        loginPageData.getJsonData();
                                        Navigator.push(
                                          context,
